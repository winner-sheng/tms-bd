...
TOOLBARS_SETTINGS = {
    ...
    "tms": [[
                    ...
                    # 'music', 'attachment', 'map', 'gmap', 'scrawl', 'insertvideo',  'insertframe', 'insertcode',
                    # 'help', 'drafts', 'snapscreen', 'wordimage',
                ]]
}
...
UEditorSettings = {
    ...
    "autoFloatEnabled": "false",  # to avoid error while dump to json for javascript
...
UEditorUploadSettings = {
    ...
    "imageMaxSize": 1048576,  #上传大小限制1MB
    "imageFieldName": "upfile",  #* 提交的图片表单名称 */
    "imageUrlPrefix": "",
    "imagePathFormat": "upload/%Y/%m/%d/",
    "imageAllowFiles": [".png", ".jpg", ".jpeg", ".gif", ],  #上传图片格式显示".bmp"
    ...
    "catcherMaxSize": 1048576,  #上传大小限制，单位1MB */
    ...
    "videoMaxSize": 10240000,  #上传大小限制，单位B，默认100MB */
    "videoUrlPrefix": "",
    "videoAllowFiles": [
    ...
    "fileMaxSize": 2048000,  #上传大小限制200MB */
