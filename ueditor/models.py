...
class UEditorField(models.TextField):
    ...
    def __init__(self, verbose_name=None, width=600, height=300, toolbars="tms", imagePath="", filePath="",
                 upload_settings=None, settings=None, command=None, event_handler=None, **kwargs):
...
try:
    ...
    add_introspection_rules([], ["^ueditor\.models\.UEditorField"])
except:
    pass
