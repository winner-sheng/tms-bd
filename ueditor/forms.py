...
class UEditorField(forms.CharField):
    def __init__(self, label, width=600, height=300, toolbars="full", imagePath="", filePath="", upload_settings=None,
                 settings=None, command=None, event_handler=None, *args, **kwargs):
