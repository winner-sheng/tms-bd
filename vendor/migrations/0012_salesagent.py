...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('vendor', '0011_auto_20161018_2130'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backup_contact', models.ForeignKey(related_name='backup_contact+', on_delete=django.db.models.deletion.SET_NULL, verbose_name='\u5907\u8054\u7cfb\u4eba', blank=True, to='vendor.Contact', null=True)),
                ...
                ('primary_contact', models.ForeignKey(related_name='primary_contact+', on_delete=django.db.models.deletion.SET_NULL, verbose_name='\u4e3b\u8054\u7cfb\u4eba', blank=True, to='vendor.Contact', null=True)),
            ],
            options={
                'ordering': ['code'],
                'verbose_name': '\u5546\u5bb6-\u9500\u552e\u5546',
                'verbose_name_plural': '\u5546\u5bb6-\u9500\u552e\u5546',
            },
        ),
    ]
